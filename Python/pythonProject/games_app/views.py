...
def game_list(request):
    ...
    return render(request, 'templates/game.html', context={'games':games})

def game_show(request, n):
    gameToShow = Game.objects.get(pk = n)
    return render(request, 'templates/show_game.html', context={'game':gameToShow})

def game_edit(request, n):
    if request.method == 'GET':
        gameToEdit = Game.objects.get(pk = n)
        platform = Platform.objects.all()
        return render(request, 'templates/game_edit.html', context={'game':gameToEdit, 'platform':platform})
...
class Game_add(View):
    def get(self, request):
        platform = Platform.objects.all()
        return render(request, 'templates/game_add.html', context={'platform':platform})
...
def game_del(request, n):
    ...
    return render(request, 'templates/game_del.html', context={'game': gameToDel, 'message':message})
...
def platform_show(request, n):
    ...
    return render(request, 'templates/platform_show.html', context={'platform': platformToShow, 'games':platformGames})