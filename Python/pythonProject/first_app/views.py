...
class PizzaView(View):
    def get(self, request):
        return render(request, 'FirstApp/templates/FirstApp/pizza.html')
    def post(self, request):
...
class CarView(View):
    def get(self, request):
        return render(request, 'FirstApp/templates/FirstApp/car.html')
    def post(self, request):
...
class LoginView(View):
    def get(self, request):
        return render(request, 'FirstApp/templates/FirstApp/login_class.html')
    def post(self, request):
...
def form(request):
    if request.method == 'GET':
        return render(request, 'FirstApp/templates/FirstApp/form.html')
...
def fizz_buzz(request, n):
    ...
    for i in range(1, n+1):
        if(i%5==0 and i%3 == 0):
            ...
            data.append(str(i))
    return render(request, 'FirstApp/templates/FirstApp/fizz_buzz.html', context={'data': data})

def multiply(request, n):
    return render(request, 'FirstApp/templates/FirstApp/multiply.html', context={'elements': range(1, n + 1)})
...
def rpg(request):
    ...
    return render(request, 'FirstApp/templates/FirstApp/rpg_game.html', context = {'tura': range(1, tura + 1), 'pDefense': pDefense,
...
def main(request):
    return render(request, 'FirstApp/templates/FirstApp/base.html')

def login_user(request, message="ok" ):
    if request.method == 'GET':
        return render(request, 'FirstApp/templates/FirstApp/login.html')
    if request.method == 'POST':
        if request.POST.get('login', '') == 'Admin' and request.POST.get('pass', '') == 'Tajne123':
            return HttpResponse("Witaj Admin!", "Brak Parametru")
        else:
...
def add_product(request):
    if request.method == 'GET':
        return render(request, 'FirstApp/templates/FirstApp/add_product_form.html')
    if request.method == 'POST':
        products[request.POST.get('product', '')] = request.POST.get('price', '')
        return redirect('/show_product')

def show_products(request):
    return render(request, 'FirstApp/templates/FirstApp/show_product.html', context={'products': products})