...
class EditBookView(View):
    def get(self, request, n):
        ...
        return render(request, 'library_app/templates/library_app/book_form.html', {'form':form,
...
def BookShow(request):
    ...
    return render(request, 'library_app/templates/library_app/mian.html', {'form': form})